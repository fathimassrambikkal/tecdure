        ...
        <div className="max-w-[1024px] mx-auto flex items-center justify-between px-6 h-[72px] relative">
          ...
          <div className="flex items-center gap-5 ml-auto">
            ...
            <div className="relative hidden md:block" ref={langRef}>
              ...
              {showLangDropdown && (
                <div className="absolute right-0 mt-3 min-w-[80px] bg-white rounded-2xl border border-[#1a1a1a]/5 shadow-[0_20px_60px_rgba(0,0,0,0.15)] py-2 z-50">
                  {["EN", "AR"].map((lang) => (
                    <button
                      key={lang}
            ...
            <div className="relative hidden md:block" ref={currencyRef}>
              ...
              {showCurrencyDropdown && (
                <div className="absolute right-0 mt-3 min-w-[90px] bg-white rounded-2xl border border-[#1a1a1a]/5 shadow-[0_20px_60px_rgba(0,0,0,0.15)] py-2 z-50">
        ...
        <>
          ...
          <div className="fixed top-0 left-0 h-full w-[300px] bg-white z-50 md:hidden shadow-2xl overflow-y-auto">
            <div className="flex justify-end p-4">
              ...
              >
                <CloseIcon className="w-5 h-5 text-[#1a1a1a] transition-transform duration-300 group-hover:rotate-90" />
              </button>
            </div>
                    ...
                    {["EN", "AR"].map((lang) => (
                      <button
                        ...
                        className={`text-[11px] font-light tracking-[0.2em] uppercase transition-colors duration-300 ${
                          language === lang ? "text-[#C9A96E]" : "text-black/70 hover:text-black"
                        }`}
                      >
                        {lang}
                      </button>
                    ...
                    {["QAR", "SAR", "AED", "USD"].map((curr) => (
                      <button
                        ...
                        className={`text-[11px] font-light tracking-[0.1em] transition-colors duration-300 ${
                          currency === curr ? "text-[#C9A96E]" : "text-black/70 hover:text-black"
                        }`}
                      >
                        {curr}
                      </button>
